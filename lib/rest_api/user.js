exports.on = function(app) {
    ...
    app.post(preRestApi + '/addUser', function(req, res) {
        ...
        user.addUser(account,password,name,gender,roles,rolesInfo,houseIds,phone,address,mail,bornDate,(result,data)=> {
    ...
    app.put(preRestApi + '/editUser', function(req, res) {
        ...
        user.editUser(id,account,password,name,gender,roles,rolesInfo,houseIds,phone,address,mail,bornDate,companyId,verify,(result,data)=> {
            response.status = result;
            response.data = data
            res.send(response);
        })
