exports.on = function(app) {
    ...
    app.post(preRestApi + '/addUser', function(req, res) {
        ...
        user.addUser(account,password,name,gender,roles,rolesInfo,houseIds,phone,address,mail,(result,data)=> {
    ...
    app.put(preRestApi + '/editUser', function(req, res) {
        ...
        user.editUser(id,account,password,name,gender,roles,rolesInfo,houseIds,phone,address,mail,(result,data)=> {
            response.status = result;
            response.data = data
            res.send(response);
        })
