...
function addUser(account,password,name,gender,roles,rolesInfo,houseIds,phone,address,mail,bornDate,callback) {
    if (utilsValue.isValid(account) && utilsValue.isValid(password)){
...
function editUser(id,account,password,name,gender,roles,rolesInfo,houseIds,phone,address,mail,bornDate, callback) {
